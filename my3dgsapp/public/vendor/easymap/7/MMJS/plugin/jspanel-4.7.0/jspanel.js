...
var jsPanel = {
  ...
  polyfills: function () {
    ...
    })([Element.prototype, Document.prototype, DocumentFragment.prototype]); // Element.closest() polyfill needed for EDGE - https://developer.mozilla.org/en-US/docs/Web/API/Element/closest
  ...
  position: function position(panel, _position) {
    ...
    var panelRect = panel.getBoundingClientRect(),
      ...
      height: window.innerHeight // fake window.getBoundingClientRect() return value
    ...
    var containerStyle = container === 'window' ? {
      ...
      borderLeftWidth: '0px' // fake getComputedStyle(window) return value
  ...
  ajax: function ajax(obj, ajaxConfig) {
    ...
    var configDefaults = {
      ...
      "pd": decodeURIComponent(encodeURIComponent('')),
        ...
        objIsPanel ? obj.content[decodeURIComponent(encodeURIComponent('innerHTML'))] = this[decodeURIComponent(encodeURIComponent('responseText'))] : obj[decodeURIComponent(encodeURIComponent('innerHTML'))] = this[decodeURIComponent(encodeURIComponent('responseText'))];
      },
      autoresize: true,
      autoreposition: true
    };
